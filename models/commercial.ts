...
export type InvoiceDocument = { _id?: ObjectId; organizationId: ObjectId; bookingId: ObjectId; invoiceNumber: string; status: "DRAFT" | "ISSUED" | "PAID" | "VOID"; subtotal: number; tax: number; fees: number; total: number; currency: string; documentKey?: string; issuedAt?: Date; createdAt: Date };
